...
class Bitsong {
  ...
  */
  ...
  async editValidator(payload, from, memo, pk, gas_price, gas_limit) {
    const msgs = [{
  ...
  async withdrawDelegationReward(payload, commission, from, memo, pk, gas_price, gas_limit) {
    const msgs = [{
